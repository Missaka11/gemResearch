        ...
        <div className="row m-0 p-5" style={{ height: "100%" }}>
          ...
          <div className="col-4 py-5 my-5 d-flex justify-content-between flex-column">
            ...
            <div style={{ fontSize: "20px", fontWeight: "normal" }}>
              Curious about the authenticity of your gemstone? Our advanced tool
              helps you capture, analyze, and verify your gem’s unique features
              with precision. Start your gem identification journey now.
            </div>
