...
const GemShapeResult = () => {
  ...
  {prediction ? (
    <div className="result">
      <h2>
        Your Gem Shape <br />
        <span style={{ color: 'red', fontSize: '60px' }}>{prediction}</span>
      </h2>
    </div>
  ) : (
  ...
  <div className="quote-section">
    <p className="quote-text">Click below to explore stunning 3D models of <br /><b> your favourite jewelry items!</b></p>
  </div>
  ...
  <p className="d-models-info">
    Explore our stunning 3D models of earrings, necklaces, rings, and bracelets! 
    Click on any of the jewelry items above to watch these items come to life in 
    breathtaking 3D detail. Discover how these pieces look from every angle and 
    envision them as part of your collection.
  </p>
